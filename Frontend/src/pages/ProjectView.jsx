                    ...
                    <div className='border-b border-gray-900/10 pb-12'>
                        <div className='mt-10 flex flex-col gap-5'>
                            ...
                            <div className='w-full sm:col-span-4'>
                                ...
                                <Link to={gitRepoLink} target='_blank' className='text-blue-400 hover:text-blue-600 break-words whitespace-normal block'>
                                    {gitRepoLink}
                                </Link>
                            </div>
                            ...
                            <div className='w-full sm:col-span-4'>
                                ...
                                <Link to={projectLink ? projectLink : "#"} className='text-blue-400 hover:text-blue-600 break-words whitespace-normal block' target='__blank'>
