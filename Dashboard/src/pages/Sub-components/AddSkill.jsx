...
import { addSkill, clearAllSkillSliceErrors, getAllSkills, resetSkillSliceErrors } from '../../store/skillSlice';
      ...
      <form className='w-full px-5 md:w-[650px]'>
        <div className='space-y-12'>
          ...
          <div className='w-full flex justify-center'>
            {
              loading ? <SpecialLoadingButton content={"Adding.."} width={"w-full sm:w-1/2"} /> : <Button type="submit" className="w-full sm:w-1/2 cursor-pointer" onClick={handleAddSkill}>Add Skill</Button>
            }
          </div>
        </div>
      </form>
